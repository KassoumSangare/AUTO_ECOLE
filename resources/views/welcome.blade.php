...
@section('head')
    <style>
        ...
        .offer-card.rouge::before {
            background: linear-gradient(90deg, var(--rouge), var(--rouge-c));
        }

        .offer-card.vert::before {
            background: linear-gradient(90deg, var(--vert), var(--vert-c));
        }

        .offer-card.or::before {
            background: linear-gradient(90deg, var(--or), var(--or-c));
        }
        ...
        .permit-badge {
            ...
            padding: .25rem .65rem;
            border-radius: 6px;
            border: 1px solid rgba(175, 38, 54, .15);
        }
                ...
                <div class="col-lg-6 d-none d-lg-block">
                    <div style="position:relative;z-index:1;animation:fade-left .7s .2s both;">
                        ...
                        <div class="stat-bubble"
                            style="bottom:28%;right:-12px;animation:fade-up .6s .55s both;border-left-color:var(--vert);">
    ...
    <div class="trust-band">
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center gap-1">
                <div class="trust-item"><i class="bi bi-patch-check-fill" style="color:var(--vert);"></i>Formation agréée
                    Côte d'Ivoire</div>
                <span class="trust-divider">·</span>
                <div class="trust-item"><i class="bi bi-shield-lock-fill" style="color:var(--rouge);"></i>Paiement sécurisé
                    Wave CI</div>
                <span class="trust-divider">·</span>
                <div class="trust-item"><i class="bi bi-phone-fill" style="color:#3B82F6;"></i>100% accessible sur mobile
                </div>
                <span class="trust-divider">·</span>
                <div class="trust-item"><i class="bi bi-award-fill" style="color:var(--or);"></i>Certificat officiel de
                    formation</div>
                <span class="trust-divider">·</span>
    ...
    <section class="about-section" id="a-propos" aria-label="Qui sommes-nous">
        <div class="container" style="position:relative;z-index:1;">
            ...
            <div class="text-center mb-5 reveal">
                ...
                <p class="section-sub">Votre partenaire de confiance pour une conduite sûre et responsable, au cœur
                    d'Abidjan.</p>
            </div>
            ...
            <div class="row g-4 align-items-stretch mb-4">
                ...
                <div class="col-lg-7 reveal">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <div
                            style="background:var(--rouge-p);border-radius:12px;padding:.75rem 1.1rem;display:flex;align-items:center;gap:.6rem;flex:1;min-width:130px;">
                            <i class="bi bi-geo-alt-fill" style="color:var(--rouge);font-size:1.2rem;flex-shrink:0;"></i>
                            <div>
                                <div href="#localisation" style="cursor:pointer;font-family:var(--font-d);font-weight:800;font-size:.88rem;color:var(--rouge);">
                                    Plateau Dokui</div>
                                <div style="font-size:.73rem;color:var(--texte-2);">Abobo, Abidjan</div>
                            </div>
                        </div>
                        <div
                            style="background:var(--vert-p);border-radius:12px;padding:.75rem 1.1rem;display:flex;align-items:center;gap:.6rem;flex:1;min-width:130px;">
                            <i class="bi bi-award-fill" style="color:var(--vert);font-size:1.2rem;flex-shrink:0;"></i>
                            <div>
                                <div
                                    style="font-family:var(--font-d);font-weight:800;font-size:.88rem;color:var(--vert-c);">
                                    Agréée</div>
                                <div style="font-size:.73rem;color:var(--texte-2);">Formation officielle CI</div>
                            </div>
                        </div>
                        <div
                            style="background:var(--or-p);border-radius:12px;padding:.75rem 1.1rem;display:flex;align-items:center;gap:.6rem;flex:1;min-width:130px;">
                            <i class="bi bi-people-fill" style="color:var(--or);font-size:1.2rem;flex-shrink:0;"></i>
                            <div>
                                <div style="font-family:var(--font-d);font-weight:800;font-size:.88rem;color:var(--texte);">
                                    1 000+</div>
                ...
                <div class="col-lg-5 reveal" style="transition-delay:.15s">
                    <div class="director-card">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <div style="cursor:pointer;" class="director-location" href="#localisation">
                                <i class="bi bi-geo-alt-fill"></i>
                                Av. Adama Toungara, Abobo
                            </div>
                ...
                <div class="row g-3">
                    <div class="col-md-4 reveal" style="transition-delay:.05s">
                        <div class="offer-card rouge">
                            <div class="offer-icon" style="background:var(--rouge-p);color:var(--rouge);"><i
                                    class="bi bi-book-fill"></i></div>
                            <div class="offer-title">Formation complète</div>
                            <p class="offer-desc">Cours théoriques approfondis sur le <strong>Code de la Route</strong> et
                                formation pratique rigoureuse en situation réelle sur les routes d'Abidjan.</p>
                        </div>
                    </div>
                    <div class="col-md-4 reveal" style="transition-delay:.12s">
                        <div class="offer-card vert">
                            <div class="offer-icon" style="background:var(--vert-p);color:var(--vert);"><i
                                    class="bi bi-card-checklist"></i></div>
                            <div class="offer-title">Permis toutes catégories</div>
                            <p class="offer-desc">Que vous souhaitiez moto, voiture ou poids lourd, nous avons la formation
                                adaptée à votre projet de conduite.</p>
                            <div class="permit-badges">
                                ...
                                <span class="permit-badge"
                                    style="background:var(--vert-p);color:var(--vert-c);border-color:rgba(45,106,79,.15);"><i
                                        class="bi bi-truck-front-fill"></i>C/D/E — Poids lourds</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 reveal" style="transition-delay:.2s">
                        <div class="offer-card or">
                            <div class="offer-icon" style="background:var(--or-p);color:var(--or);"><i
                                    class="bi bi-stars"></i></div>
                            <div class="offer-title">Services post-permis</div>
                            <p class="offer-desc">Modules de <strong>perfectionnement à la conduite</strong> pour regagner
                                en assurance au volant et sécuriser votre pratique quotidienne sur les routes ivoiriennes.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4 reveal" style="transition-delay:{{ $i * 0.15 }}s">
                        <div class="step-card">
                            ...
                            <span class="step-badge"
                                style="background:{{ $step['color'] }}1A;color:{{ $step['color'] }};">{{ $step['badge'] }}</span>
                        </div>
                    </div>
                    @if($i < count($steps) - 1)
                        <div class="col-auto d-none d-md-flex steps-connector"><i class="bi bi-chevron-right"></i></div>
                    @endif
                @endforeach
            </div>
        </div>
                ...
                @foreach($features as $i => [$icon, $bg, $color, $title, $desc])
                    <div class="col-sm-6 col-lg-3 reveal" style="transition-delay:{{ $i * 0.1 }}s">
                        <div class="feature-card">
                            <div class="feature-icon" style="background:{{ $bg }};color:{{ $color }};"><i
                                    class="bi {{ $icon }}"></i></div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8 reveal">
                    <div class="pricing-card">
                        ...
                        <div class="category-selector">
                            @foreach($categories as $index => $category)
                                <button class="category-btn {{ $index === 0 ? 'active' : '' }}"
                                    data-category="{{ $category->code }}" data-name="{{ $category->name }}"
                                    data-description="{{ $category->description }}" data-price="{{ $category->price }}"
                        ...
                        <div class="pricing-name" id="categoryName">{{ $categories->first()?->name ?? 'Aucune catégorie' }}
                        </div>
                        <div class="pricing-description" id="categoryDescription">
                            {{ $categories->first()?->description ?? 'Sélectionnez une catégorie ci-dessus' }}</div>
                        <div class="pricing-price-container">
                            <div class="pricing-original-price" id="originalPrice">
                                Prix normal : <span
                                    id="originalPriceValue">{{ number_format($categories->first()?->price ?? 0, 0, ',', ' ') }}</span>
                                XOF
                            </div>
                            <div class="pricing-discount-badge">
                                <i class="bi bi-percent"></i>
                                <span id="discountPercent">{{ $categories->first()?->online_discount_percent ?? 0 }}</span>%
                                de réduction en ligne
                            </div>
                            <div class="pricing-price-row">
                                <div class="pricing-price"><sup>CFA</sup><span
                                        id="discountedPrice">{{ number_format($categories->first()?->discounted_price ?? 0, 0, ',', ' ') }}</span>
                                </div>
                        ...
                        <ul class="pricing-list">
                            <li>
                                <div class="pi"><i class="bi bi-check2"></i></div>Médiathèque vidéo illimitée (Code +
                                Conduite)
                            </li>
                            <li>
                        ...
                        <div class="pricing-note">
                            <strong>NB :</strong> Les frais de retrait du permis ne sont pas inclus dans le montant de la
                            formation initiale.
                        </div>
                    </div>
                </div>
    ...
    <section class="preview-section" aria-label="Aperçu de la plateforme">
        <div class="container">
            ...
            <div class="preview-tabs justify-content-center mb-4">
                <button class="preview-tab active" onclick="showPreview('quiz', this)"><i
                        class="bi bi-patch-question-fill me-1"></i>Quiz QCM</button>
                <button class="preview-tab" onclick="showPreview('dashboard', this)"><i
                        class="bi bi-speedometer2 me-1"></i>Tableau de bord</button>
                <button class="preview-tab" onclick="showPreview('docs', this)"><i
                        class="bi bi-folder2-open me-1"></i>Documents</button>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="preview-frame active" id="preview-quiz">
                        <div class="preview-topbar">
                            ...
                            <span style="color:rgba(255,255,255,.5);font-size:.75rem;margin-left:1rem;">Quiz — Code de la
                                Route</span>
                        </div>
                        <div class="preview-body">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span style="font-size:.78rem;color:var(--texte-2);font-weight:600;">Question 9 / 20</span>
                                <span style="font-size:.78rem;color:var(--rouge);font-weight:700;"><i
                                        class="bi bi-clock me-1"></i>22:15</span>
                            </div>
                            ...
                            <div class="mock-option correct"><i class="bi bi-check-circle-fill me-2"></i>B. Le véhicule
                                venant de droite ✓</div>
                            <div class="mock-option">C. Le véhicule le plus rapide</div>
                            <div class="mock-option">D. Le véhicule le plus lourd</div>
                            <div class="mt-2 p-2"
                                style="background:var(--vert-p);border-radius:8px;font-size:.8rem;color:var(--vert-c);">
                                <i class="bi bi-lightbulb-fill me-1"></i><strong>Explication :</strong> En Côte d'Ivoire, la
                                règle de priorité à droite s'applique sauf signalisation contraire.
                            </div>
                        </div>
                    </div>
                    <div class="preview-frame" id="preview-dashboard">
                        <div class="preview-topbar">
                            ...
                            <div class="preview-dot ms-1" style="background:#FEBC2E;"></div>
                            <div class="preview-dot ms-1" style="background:#28C840;"></div>
                            <span style="color:rgba(255,255,255,.5);font-size:.75rem;margin-left:1rem;">Tableau de bord —
                                Espace Élève</span>
                        </div>
                        <div class="preview-body">
                            ...
                            <div class="mb-2">
                                <div class="d-flex justify-content-between mb-1" style="font-size:.8rem;font-weight:700;">
                                    <span>Code de la route</span><span style="color:var(--rouge);">78%</span></div>
                            ...
                            <div>
                                <div class="d-flex justify-content-between mb-1" style="font-size:.8rem;font-weight:700;">
                                    <span>Conduite</span><span style="color:var(--vert);">65%</span></div>
                                <div class="mock-prog-bar">
                    ...
                    <div class="preview-frame" id="preview-docs">
                        <div class="preview-topbar">
                            ...
                            <div class="preview-dot ms-1" style="background:#FEBC2E;"></div>
                            <div class="preview-dot ms-1" style="background:#28C840;"></div>
                            <span style="color:rgba(255,255,255,.5);font-size:.75rem;margin-left:1rem;">Coffre-fort
                                numérique — Documents</span>
                        </div>
                        <div class="preview-body">
                            <div class="mock-doc-row">
                                <div class="mock-doc-icon" style="background:var(--rouge-p);color:var(--rouge);"><i
                            ...
                            <div class="mock-doc-row">
                                <div class="mock-doc-icon" style="background:var(--or-p);color:var(--or);"><i
                            ...
                            <div class="mock-doc-row">
                                <div class="mock-doc-icon" style="background:var(--vert-p);color:var(--vert);"><i
                                        class="bi bi-file-medical-fill"></i></div>
                                <div>
                ...
                @foreach($testimonials as $i => [$nom, $lieu, $texte, $note])
                    <div class="col-md-6 col-lg-3 reveal" style="transition-delay:{{ $i * 0.1 }}s">
                        <div class="testi-card">
                            ...
                            <p
                                style="font-size:.88rem;color:var(--texte);line-height:1.7;margin-bottom:1rem;padding-top:.5rem;">
                                "{{ $texte }}"</p>
                            <div style="display:flex;align-items:center;gap:.7rem;margin-top:auto;">
                                <div
                                    style="width:36px;height:36px;border-radius:50%;background:var(--rouge);color:#fff;display:flex;align-items:center;justify-content:center;font-weight:800;font-family:var(--font-d);font-size:.85rem;flex-shrink:0;">
                                    {{ strtoupper(substr($nom, 0, 1)) }}</div>
                                <div>
                    ...
                    <div class="row g-4 h-100">
                        <div class="col-12">
                            <div class="info-card reveal">
                                <div class="info-card-header">
                                    <div class="info-card-icon" style="background:var(--rouge);"><i
                                            class="bi bi-telephone-fill" style="color:#fff;"></i></div>
                                    <h3 class="info-card-title">Contact</h3>
                                </div>
                                <div class="info-card-body">
                                    <a href="tel:+2252724318838" class="contact-row">
                                        <div class="contact-row-icon" style="background:var(--vert);"><i
                                    ...
                                    <a href="https://wa.me/2250545160597" target="_blank" class="contact-row">
                                        <div class="contact-row-icon" style="background:#25D366;"><i
                                                class="bi bi-whatsapp"></i></div>
                                        <span class="contact-row-text"><strong>05 45 16 05 97</strong><br>WhatsApp & Appel
                                            7j/7</span>
                                    </a>
                                    <div class="contact-row">
                                        <div class="contact-row-icon" style="background:#F97316;"><i
                                                class="bi bi-geo-alt-fill"></i></div>
                                        <span class="contact-row-text">Non loin de la Grande Pharmacie du Dokui, Avenue
                                            ADAMA TOUNGARA — Plateau Dokui, Abobo, Abidjan</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="info-card reveal" style="transition-delay:.15s">
                                <div class="info-card-header">
                                    <div class="info-card-icon" style="background:var(--vert);"><i class="bi bi-clock-fill"
                                ...
                                <div class="info-card-body">
                                    ...
                                    @foreach($horaires as $i => [$jour, $heure, $ferme])
                                        <div class="hours-row {{ $i === $todayIdx ? 'today' : '' }} {{ $ferme ? 'ferme' : '' }}">
                                            <span class="hours-day">@if($i === $todayIdx)<i class="bi bi-circle-fill"
                                            style="font-size:.4rem;color:var(--vert);"></i>@endif{{ $jour }}</span>
                ...
                <div class="col-lg-8 reveal" style="transition-delay:.1s">
                    <div class="map-card h-100">
                        <div class="map-card-header" id="localisation">
                            <div class="info-card-icon" style="background:var(--rouge);"><i class="bi bi-pin-map-fill"
                                    style="color:#fff;"></i></div>
                            <h3 class="info-card-title">Localisation — Abobo Dokui, Abidjan</h3>
                        </div>
                        <div style="padding:0 1.5rem;">
                            <div
                                style="border-radius:14px;overflow:hidden;border:1px solid var(--border);margin-top:.25rem;">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3972.1!2d-4.003776!3d5.408777!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNcKwMjQnMzEuNiJOIDTCsDAwJzEzLjYiVw!5e0!3m2!1sfr!2sci!4v1699000000000"
                                    width="100%" height="340" style="border:0;display:block;" allowfullscreen=""
                                    loading="lazy" title="Auto-École Le Chemin"></iframe>
                            </div>
                        </div>
                        <div class="map-gps-btns">
                            <a href="https://www.google.com/maps/dir/?api=1&destination=5.408777,-4.003776" target="_blank"
                                rel="noopener" class="map-btn map-btn-google"><i class="bi bi-map-fill"></i>Itinéraire
                                Google Maps</a>
                            <a href="https://waze.com/ul?ll=5.408777,-4.003776&navigate=yes" target="_blank" rel="noopener"
                                class="map-btn map-btn-waze"><i class="bi bi-car-front-fill"></i>Itinéraire Waze</a>
                        </div>
                        <div style="padding:.25rem 1.5rem 1.25rem;">
                            <div
                                style="background:var(--bg);border-radius:12px;padding:.85rem 1rem;display:flex;align-items:flex-start;gap:.65rem;">
                                <i class="bi bi-geo-alt-fill"
                                    style="color:var(--rouge);font-size:1rem;margin-top:.1rem;flex-shrink:0;"></i>
                                <span style="font-size:.82rem;color:var(--texte-2);line-height:1.55;">Non loin de la Grande
                                    Pharmacie du Dokui, Avenue ADAMA TOUNGARA près Groupe Scolaire Sainte Jeanne — Plateau
                                    Dokui Abobo, Abidjan, Côte d'Ivoire</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="cta-section" aria-label="Inscription">
        <div class="container" style="position:relative;z-index:1;">
            <div class="reveal">
                ...
                <p
                    style="color:rgba(255,255,255,.82);max-width:500px;margin:.75rem auto 2rem;font-size:1rem;line-height:1.7;">
                ...
                <p style="color:rgba(255,255,255,.5);font-size:.8rem;margin-top:1.25rem;">
                    <i class="bi bi-shield-check me-1"></i>Inscription gratuite · Paiement sécurisé Wave · Annulation
                    possible
                </p>
            </div>
        </div>
